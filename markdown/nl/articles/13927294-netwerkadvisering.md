...
- Catenda-domeinen:
  - `catenda.com`
  - `*.catenda.com`
    - `webviewer.catenda.com`<br>Dit subdomein moet in de firewall worden toegestaan om de preview van documenten op de documentpreviewpagina weer te geven.
  - `*.*.catenda.com`
...
- Voor gebruik van plugins en integraties die topics gebruiken die [hier](https://support.catenda.com/nl/articles/8396532-catenda-invoegtoepassingen-integraties) worden vermeld
