# Gratis IGN-puntenwolken (HD LiDAR) toevoegen aan een project
...
1. Ga naar de officiële downloadpagina van Miniconda: <br>👉 [https://docs.conda.io/en/latest/miniconda.html](https://docs.conda.io/en/latest/miniconda.html)
