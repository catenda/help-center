...
Gepubliceerd - `publishedAtFrom=<UTC timestamp>&publishedAtTo=<UTC timestamp>` Klik op datums selecteren om datums te selecteren waartussen u wilt zoeken Klik [hier](https://support.catenda.com/nl/articles/6511685-datumfilter) om meer te lezen over het datumfilter
...
Verwijderd - `deleted=deleted&subFolders=true` Zie [hier](https://support.catenda.com/nl/articles/4670249-documenten-verwijderen-ongedaan-maken-documenten-of-mappen-herstellen) hoe u kunt zoeken naar verwijderde documenten
