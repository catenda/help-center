...
Op de [inlogpagina](https://support.catenda.com/nl/articles/7891486-aanmeldingspagina) wordt u gevraagd uw wachtwoord in te voeren. Dezelfde inlogpagina wordt gebruikt zowel bij inloggen via de browser als bij inloggen om toegang tot uw account via de API te geven, wat u doet met veel van onze plugins. Tijdens dit proces kunnen de volgende uitdagingen ontstaan:
