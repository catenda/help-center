...
![](images/03-quantity-take-off.png)
...
![](images/06-how-do-i-know-if-my-ifc-has-4d-information-in-it.png)

Where you can find the entity in the statistics panel:

![](images/07-how-do-i-know-if-my-ifc-has-4d-information-in-it.png)

## 5. **Selections**

This lets you create a set of objects which can then be styled and colorized.

![](images/08-selections.png)
