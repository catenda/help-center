...
The Catenda Archicad plugin is a plugin that can be installed for Nemetchek Archicad.
...
**[Installation](#h_e385b268de) - [Catenda palette](#h_8f1a4c7878) - [Sign in](#h_1c0212d551) - [Project list](#h_f708fc0419) - [Topic board](#h_321a0e596b) - [Topic](#h_37dceffce4)**
...
Plugin will appear as enabled in the add on manager the next time Archicad is opened up.

Note that this is different from the default add-on folder which is located at
...
In this menu you will find the window "Catenda Hub Issue Manager" which contains the "Catenda Hub Issue Manager Palette". In order to start using this palette either a floor plan or a 3D view will have to be opened.
...
After granting this access the Archicad plugin will show up as an application on the [applications page](https://support.catenda.com/en/articles/6880968-account-page#h_40e031c49a) of your Catenda account.
...
If it takes longer 5 minutes please contact support at [support@catenda.com](mailto:support@catenda.com)
...
As soon as you have accepted the invitation to a project you will see your project appear in the list of your projects in the plugin and on the [projects page](https://support.catenda.com/en/articles/8400797-projects-page). **Action menu**

Click on the three dots next to your profile picture to open the action menu dropdown:
...
By default the file name will be the name of the Archicad project. This will become the name of the revision in Catenda
...
Hover over the coordinates option to expand the coordinates menu.

This is what the coordinates menu can look like:

![](https://raw.githubusercontent.com/catenda/help-center/main/images/cxr3wm2a/08-project-list.png)

In the coordinates menu coordinates can be chosen to be relative to:

Survey Point - Default
...
Click in the search bar to highlight it.

This is what the hightlighted searchbar can look like:

![](https://raw.githubusercontent.com/catenda/help-center/main/images/cxr3wm2a/10-search.png)

After clicking in the searchbar a dropdown with suggested filters opens up.

Select any of the filters to apply them.

Click on the x next to the filer to remove it again.

Start typing to narrow down the suggested filters or perform a text search.
...
The entries starting with an `@` are assigned teams that are listed first.

After that assigned project members are listed.

**Requested by**

The entries starting with an `@` are teams requesting topics that are listed first.

After that project members requesting topics are listed.
...
Text can be searched on by typing in the serach bar.
...
Single character - No results. At least two characters are required for a text serach

Two characters - Full words, separated by spaces, that matches the search phrase are included in the results.

### **Sort**

Click on Sort to open the sort menu.

This is what the sort menu can look like:

![](https://raw.githubusercontent.com/catenda/help-center/main/images/cxr3wm2a/12-sort.png)

Click on any of the options to sort the topics list by:

_Newest_ - Default

Topics with the newest creation date
