...
On the models page all IFC documents that are linked to a model can be seen.

Typically a model for each discipline can be found here. This is what the models page can look like:
...
**[New item actions](#h_5dc7dabe3a) - [Search or filter options](#h_330a5c2a91) - [Right menu](#h_ac840d5d23) - [Models table](#h_bbc42c56bb) - [Sub pages](#h_f549b192ca)**
...
When the table is first loaded in, up to 100 rows are displayed.

If more than 100 rows are in the table scroll down to the bottom to load in the next 100 rows.

Each model row is linked to a document on the documents page.

**Access**

Model rows are displayed based on the access to the document that is linked to the model.

_Access required -_ Read

Opening the content of a model row opens the [model overview page](https://support.catenda.com/en/articles/4670270-model-page) of that model.
...
_Access required_ - Access to viewing shared revisions in the document
