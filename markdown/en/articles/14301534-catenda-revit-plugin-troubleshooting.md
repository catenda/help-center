...
In the filename and comment fields of the upload model dialogue only ASCII characters are supported for upload. To find out which characters are in the ASCII set see [this Wikipedia article](https://en.wikipedia.org/wiki/ASCII).
...
Please restart Revit after encountering this error in order to continu uploading.

## 2. **Manage Links window**
...
### 3.1 **Unsupported Edition: Revit LT**
...
### 4.1 **Operational Warning for Dynamo Users**
