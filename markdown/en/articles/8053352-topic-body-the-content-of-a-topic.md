...
Select a topic from an [topic board](https://support.catenda.com/en/articles/4670271-issues-page#h_6a5895256b) a to open the topic page of the topic.

This is what the [topic banner](https://support.catenda.com/en/articles/7986346-topic-banner-navigating-topics) on the topic page can look like:
...
Below the topic header the topic body can be found with description and comments. The topic body is described in this article.

To the right of the topic body and header the [right information panel](https://support.catenda.com/en/articles/8053299-issue-right-panel) can be found.
...
**[Progress bar](#h_7b73deaf7d) - [Description](#h_952e4743da) - [Topic information](#h_15569a8464) - [Comment section](#h_0e3c0059ae)**
...
For a short video tutorial about check lists see [here](https://support.catenda.com/en/articles/5036461-check-lists-within-issues)
...
Descriptions follow the general rules of [formatting of posts](https://support.catenda.com/en/articles/8430847-formatting-of-posts) on Catenda.
...
To get a more specific time go to [account settings](https://support.catenda.com/en/articles/6880968-account-page#h_4aa257b72f).
...
See [this article](https://support.catenda.com/en/articles/8613038-issue-history) for what topic history is possible to see on Catenda Hub.
...
_Access required:_ comment creator
...
![](https://raw.githubusercontent.com/catenda/help-center/main/images/040pbsjh/09-comment.png)
...
**[Image](#h_fb43bacd99) - [2D and 3D snapshots](#h_1ba7f8873f) - [Annotation](#h_e98c0964d4)**
...
The image can now connect it to objects and a position in the viewer. Submit this comment to play back the viewpoint by clicking on the play button. Annotations can be added to the image after adding the image and before submitting the comment.

**Image pop-out**

The image that is attached to the comment after the comment is submitted can be [popped-out](#h_e36d14edc8) to see a its contents in a larger format and download it after it has been submitted.
...
![](https://raw.githubusercontent.com/catenda/help-center/main/images/040pbsjh/10-2d-or-3d-snapshots.png)
...
![](https://raw.githubusercontent.com/catenda/help-center/main/images/040pbsjh/11-2d-or-3d-snapshots.png)

2D snapshots have the same buttons but with an image of the 2D viewer attached.

Click [here](https://support.catenda.com/en/articles/10345863-snapshots) to read more about snapshot configuration
...
![](https://raw.githubusercontent.com/catenda/help-center/main/images/040pbsjh/12-markup.png)
...
The annotation comment follows the [general rules for formatting of posts](https://support.catenda.com/en/articles/8430847-formatting-of-posts) with a minor difference when it comes to checklists.
...
- A play button
    - The document preview of the revision that the annotations of the markup are on can be opened on the documents page when the play button is clicked.
    - _Access required:_
        - Read access to the document that the markup is on.
        - Access to viewing shared revisions in the document if the markup is on a shared revision.
    - The document preview will not show the document if:
        - The document revision has been withdrawn
        - The document has been deleted.
- The page that the annotations are on in the document revision
- The amount of annotations on the page in the document revision
...
![](https://raw.githubusercontent.com/catenda/help-center/main/images/040pbsjh/13-new-comment.png)
...
Text submitted in the text box of a comment follows the [general formatting rules of posts](https://support.catenda.com/en/articles/8430847-formatting-of-posts) on Catenda.
