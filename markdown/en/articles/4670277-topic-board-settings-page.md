...
> **注：**「トピックボード」をクリックすると、アーカイブされたトピックボード内のトピックを確認できます。リストの一番下で「アーカイブを表示」を選択できます。
...
> **注：**オープンのメタステータスを持つトピックのステータスを、クローズのメタステータスを持つステータスへ変更できるユーザーは、[アクセス制御セクション](#h_82063f7a79)で設定できます。
...
> **注：**1つのトピックボードにつき、最大30個のカスタムフィールドを追加できます。
