...
Klicken Sie [hier](https://support.catenda.com/de/articles/8551755-filterergebnisse-begrenzen), um mehr darüber zu erfahren, wie Sie eine Reihe von Filtern speichern
...
Veröffentlicht - `publishedAtFrom=<UTC timestamp>&publishedAtTo=<UTC timestamp>` Klicken Sie auf Daten auswählen, um Daten auszuwählen, zwischen denen Sie suchen möchten Klicken Sie [hier](https://support.catenda.com/de/articles/6511685-datum-filter), um mehr über den Datumfilter zu erfahren
