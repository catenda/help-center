# Kostenlose IGN-Punktwolken (HD LiDAR) zu einem Projekt hinzufügen
...
1. Gehen Sie zur offiziellen Miniconda-Download-Seite: <br>👉 [https://docs.conda.io/en/latest/miniconda.html](https://docs.conda.io/en/latest/miniconda.html)
