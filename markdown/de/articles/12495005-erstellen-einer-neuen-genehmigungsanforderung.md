...
Die Beschreibung der Genehmigung folgt den [allgemeinen Formatierungsregeln für Beiträge](https://support.catenda.com/de/articles/8430847-toolbox-fur-beitragformatierung). Die Beschreibung kann später korrigiert werden, sowohl während die Anfrage noch ein Entwurf ist, als auch nachdem sie eingereicht wurde.
...
\# - _Standard_ Die Haupt- und Nebenversionsnummer der geteilten Überarbeitung (#0.1, #0.2, #1.1, usw.)
...
### 3.1 **Mehr als 1000 Dokumente in Entwürfen**
...
### 3.2 **Überprüfungsdauer des ersten Schritts starten, wenn bereit**
