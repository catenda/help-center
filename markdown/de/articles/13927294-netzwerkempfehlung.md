...
- Catenda-Domänen:
    - `catenda.com`
    - `*.catenda.com`
        - `webviewer.catenda.com`<br>Diese Subdomain muss in der Firewall zugelassen werden, um die Vorschau von Dokumenten auf der Dokumentvorschauseite anzuzeigen.
    - `*.*.catenda.com`
...
- Zur Verwendung von Plugins und Integrationen, die Themen verwenden, die [hier](https://support.catenda.com/de/articles/8396532-catenda-plugins-and-integrations) aufgelistet sind
