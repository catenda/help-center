...
プロジェクトを開こうとしたときに多要素認証が必要であることを示すメッセージが表示される場合は、ブラウザで Catenda アカウントにログインし、アカウント設定で[コードペアリングを設定](https://support.catenda.com/ja/articles/4969891-multi-factor-authentication)してください。
