...
1\. [ユーザーページ](https://support.catenda.com/ja/articles/8508311-ユーザーページ-組織ツール)に移動します
...
4\. [プロジェクトに追加](https://support.catenda.com/ja/articles/8508311-ユーザーページ-組織ツール#h_8196c5add6)アクションボタンを使用します。
...
1\. [プロジェクトページ](https://intercom.help/bimsync-arena/ja/articles/8505058-プロジェクトページ-organization-tool)に移動します
...
3\. [新しいメンバーを追加](https://support.catenda.com/ja/articles/8505058-プロジェクトページ-organization-tool#h_c7ebf87db6)アクションボタンを使用し、追加する組織メンバーを選択します。
...
1\. [プロジェクトメンバーシップページ](https://intercom.help/bimsync-arena/ja/articles/9003642-プロジェクトメンバー-組織ツール)に移動します
...
4\. [プロジェクトロール（複数）を変更](https://support.catenda.com/ja/articles/9003642-プロジェクトメンバー-組織ツール#h_678ea5e6dc)アクションを使用して、フィルタリングされたメンバーのロールをすべてのプロジェクトで一度に変更します。 5\. 選択したメンバーが持つロールを選択し、[変更]をクリックします。
