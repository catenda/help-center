...
> **注意:** プラグインのインストールファイルは[この記事](https://intercom.help/bimsync-arena/ja/articles/8396532-catenda-プラグイン-統合)にあります。
...
プロジェクトへの招待を受け入れると、プラグイン内のプロジェクトリストと[プロジェクトページ](https://support.catenda.com/ja/articles/8400797-プロジェクトページ)にプロジェクトが表示されます。
