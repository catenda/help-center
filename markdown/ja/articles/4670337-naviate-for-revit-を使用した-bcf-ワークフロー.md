# Naviate for Revit を使用した BCF ワークフロー
...
BCF ファイルを保存をクリックし、bcfzip ファイルとして保存します。
