...
> **注意:** プラグインのインストール ファイルは、[このナレッジベース記事](https://intercom.help/bimsync-arena/ja/articles/8396532-catenda-プラグイン-統合)で確認できます。
...
Catenda Hub の Web アプリケーション上の Catenda Hub [アカウント ページ](https://support.catenda.com/ja/articles/6880968-アカウントページ#h_40e031c49a)に移動することで、いつでも Catenda Hub アカウントへのアクセスを取り消すことができます。
