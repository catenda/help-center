...
Konfigurerte mapper kan identifiseres ved tanntakk-merket på [mappeikonet](https://support.catenda.com/nb/articles/8466850-kolonner-pa-dokumentsiden#h_6af15c36b3). Dette er hvordan en revisjon med en generert QR-kode kan se ut:

![](https://raw.githubusercontent.com/catenda/help-center/main/images/jv55kyf8/01-intro.png)

## 1. **Mappekonfigurasjon**

QR-kode-stempling kan [aktiveres for konfigurerte mapper](https://support.catenda.com/nb/articles/7831371-dokumentinnstillinger#h_166a269870) på dokumentsiden. _Nødvendig tilgang:_ Administrator
...
For å tildele QR-kode-stempling til en mappe, gå til [dokumentinnstillinger](https://support.catenda.com/nb/articles/7831371-dokumentinnstillinger) som kan finnes som en underside av [dokumentsiden](https://support.catenda.com/nb/articles/8204673-dokumenter-side). I dokumentinnstillinger utvider du [mappeinnstillingmeny](https://support.catenda.com/nb/articles/7831371-dokumentinnstillinger#h_6672c14d90). Dette er hvordan mappeinnstillingmenyen kan se ut:
...
Klikk [her](https://support.catenda.com/nb/articles/9360508-qr-kode-pa-pdf-er-i-catenda) for å lese mer om hvordan du plasserer plassholdingen på en PDF. Dette er hvordan plassholdingen kan se ut når den er plassert i tittelblokken på en tegning:
