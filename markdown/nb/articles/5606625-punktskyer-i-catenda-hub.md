...
Punktskydataset (PC) kan visualiseres inne i Catenda Hub Individuelle PC kan forhåndsvises inne i dokumentområdet. Flere PC kan lastes inn i [3D-viseren](https://support.catenda.com/nb/articles/8227211-3d-viser). I 3D-viseren kan PC vises sammen med andre 3D-dokumentformater som IFC-modeller og GML-filer.
...
> **Merk:** Før du konfigurerer 3D-viseren, må du sørge for at programmet Catenda er åpent i er konfigurert [som anbefalt](https://support.catenda.com/nb/articles/6921941-maskinvareanbefalinger).

Innstillinger som kan brukes til å konfigurere punktskyer er plassert på to steder.

### 3.1 **1. Punktbudsjett:**

Punktbudsjettet kan konfigureres i [3D-viserinnstillingene](https://support.catenda.com/nb/articles/5784718-3d-viser-innstillinger) som finnes i tannhjulikonet øverst til høyre i 3D-viseren.
...
Øverst til venstre i 3D-viseren finner du [Revisjonvelgeren](https://support.catenda.com/nb/articles/4670246-godta-en-invitasjon-til-a-bli-med-i-et-prosjekt).
...
I [modellmenyen](https://support.catenda.com/nb/articles/4670279-revisjonsvelger#h_180a64490d) kan du finne de individuelle [3D-dokumentene](https://support.catenda.com/nb/articles/4670279-revisjonsvelger#h_fce60074ef) som du har lastet inn i 3D-viseren.
...
> **Merk:** Sørg for at maskinvaren og programvaren Catenda er åpnet på er konfigurert [som anbefalt](https://support.catenda.com/nb/articles/6921941-maskinvareanbefalinger) da dette kan ha en effekt på typen punktstørrelseslasting enheten din kan håndtere.
