...
På [påloggingssiden](https://support.catenda.com/nb/articles/7891486-paloggingsside) blir du bedt om å skrive inn passordet ditt. Den samme påloggingssiden brukes både når du logger inn via nettleseren og når du logger inn for å gi tilgang til kontoen din via APIen, som du gjør med mange avPlugInnene våre. Under denne prosessen kan følgende utfordringer oppstå:
