# Bruk av saksmaler i en saksliste

> Bruk en generell saksmal ved opprettelse av sak

Generelle saksmaler kan konfigureres på [siden for innstillinger for saksmaler](https://support.catenda.com/en/articles/14076010-topic-template-settings-page). _Påkrevd tilgang:_ Prosjektadministrator

![](https://raw.githubusercontent.com/catenda/help-center/main/images/be4v7emn/01-intro.png)

1. Først opprett en ny sak fra den vanlige saksdelen.<br>_Tilgang kreves:_ Skrivetilgang til en saksliste.

2. Velg deretter riktig saksliste som du vil opprette saken din i.<br>_Tilgang kreves:_ Skrivetilgang til saklisten.

3. Avhengig av saklisten du har valgt, hvis generelle saksmal er konfigurert av en administrator, kan de være tilgjengelige og foreslått i Mal-rullegardinmenyen.<br>
...
5. Du kan til slutt lagre saken din ved å klikke på "Send"-knappen.<br>
