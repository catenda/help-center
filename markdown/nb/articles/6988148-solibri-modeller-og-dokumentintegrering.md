...
Hvis du ikke allerede er logget inn på Catenda, blir du bedt om å [logge inn](https://support.catenda.com/nb/articles/7891486-paloggingsside). Etter å ha åpnet for første gang, etter innlogging, eller hvis du allerede var logget inn, blir du bedt om tillatelse for å få tilgang til Catenda-kontoen din:
