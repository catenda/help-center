...
_Nødvendig tilgang:_ Medlemmer og administratorer må være del av et innleveringsteam som er konfigurert for en arbeidsflyt for å kunne velge arbeidsflyten.
...
_Nødvendig tilgang:_ Medlemmer og administratorer må være del av et innleveringsteam som er konfigurert for en arbeidsflyt for å kunne sende inn på vegne av det innleveringsteamet.

### 1.3 **Tittel**

Tittelen på gjennomgangen. En gjennomgang må ha en tittel for å kunne sendes inn. Tittelen kan korrigeres senere, både mens forespørselen fortsatt er et utkast og etter at den er sendt inn.
...
Beskrivelsen av gjennomgangen følger [de generelle formateringsreglene for innlegg](https://support.catenda.com/nb/articles/8430847-verktoy-for-formatering-av-innlegg). Beskrivelsen kan korrigeres senere, både mens forespørselen fortsatt er et utkast og etter at den er sendt inn.
...
\# - _Standard_ Hoved- og underrevisjonsnummeret for den delte revisjonen (#0.1, #0.2, #1.1, osv...)
...
### 3.1 **Mer enn 1000 dokumenter i utkast**
...
### 3.2 **Start vurderingsvarighet for trinn 1 når klar**
...
Etter at en gjennomgangforespørsel er sendt inn for vurdering med den nye valideringarbeidsflyten, er det eneste som kan endres at delte revisjonsdokumenter kan forkastes fra forespørselen. Medlemmer av innsendingsteamet og medlemmer av det endelige vurderingsteamet kan forkaste dokumentrevisjoner gjennom hele arbeidsflyten. Medlemmer av et team som er tildelt et vurderingstrinn kan gjøre det bare mens det trinnet er aktivt.
