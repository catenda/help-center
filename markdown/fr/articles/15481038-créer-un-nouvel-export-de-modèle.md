...
Cliquez sur le bouton plus vert en haut à droite de la [page d'export de modèle](https://support.catenda.com/fr/articles/4670280-page-d-export-de-modele) pour créer un nouvel export de modèle. Il y a quatre étapes pour créer un nouvel export de modèle. Voici à quoi peut ressembler la première étape du processus de création d'export de modèle :
