...
Il est recommandé d'utiliser le [Connecteur Catenda Desktop](https://support.catenda.com/fr/articles/8358861-connecteur-catenda-desktop) ou de compresser votre fichier PC dans un dossier zippé et d'utiliser l'[importation zip](https://support.catenda.com/fr/articles/7945410-telecharger-un-fichier-zip-structure-de-fichiers) pour télécharger votre PC. Ces méthodes vous aideront à gagner du temps car la taille du fichier à télécharger sera plus petite et cela minimisera le risque d'erreur réseau puisque le fichier sera téléchargé plus rapidement
...
> **Remarque :** Avant de configurer la Visionneuse 3D, assurez-vous que l'application Catenda sur laquelle vous travaillez est configurée [comme recommandé](https://support.catenda.com/fr/articles/6921941-recommandation-materielle).
...
Le budget des points peut être configuré dans les [paramètres de la Visionneuse 3D](https://support.catenda.com/fr/articles/5784718-parametres-de-la-visionneuse-3d) qui se trouvent dans l'icône d'engrenage en haut à droite de la Visionneuse 3D.
...
En haut à gauche de la Visionneuse 3D, vous trouverez le [sélecteur de révision](https://support.catenda.com/fr/articles/4670246-accepter-une-invitation-pour-rejoindre-un-projet).
...
Dans [le menu des modèles](https://support.catenda.com/fr/articles/4670279-selecteur-de-revision#h_180a64490d), vous pourrez trouver les [documents 3D](https://support.catenda.com/fr/articles/4670279-selecteur-de-revision#h_fce60074ef) individuels que vous avez chargés dans la Visionneuse 3D.
...
> **Remarque :** Assurez-vous que le matériel et le logiciel sur lesquels Catenda est ouvert sont configurés [comme recommandé](https://support.catenda.com/fr/articles/6921941-recommandation-materielle) car cela peut affecter le type de chargement de taille de point que votre appareil peut gérer.
