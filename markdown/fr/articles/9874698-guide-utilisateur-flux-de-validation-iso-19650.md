...
_Accès requis_ L'accès à la configuration du statut du document dans la [zone de contrôle d'accès](https://support.catenda.com/fr/articles/4670273-page-des-parametres-du-projet#h_3b98ced32a) de la [page des paramètres du projet](https://support.catenda.com/fr/articles/4670273-page-des-parametres-du-projet). Les membres ayant cet accès n'auront accès qu'au menu de configuration du statut dans les paramètres du document. Ils ne pourront pas voir ou modifier les autres menus dans les paramètres du document.

Sous [paramètres du document](https://support.catenda.com/fr/articles/7831371-page-des-parametres-du-document), accédez à [Workflow de statut](https://support.catenda.com/fr/articles/7831371-page-des-parametres-du-document#h_e6f3ffdbff) et activez les statuts partagés
...
**Onglet Workspace** La dernière révision de l'onglet workspace peut être : révision partagée - _Accès requis :_ Révisions partagées Révision publiée - _Accès requis :_ Lecture
...
Sélectionnez un seul document ou ouvrez l'aperçu du document en cliquant sur le document. Les informations sur la révision actuelle seront visibles dans le [menu d'information de droite](https://support.catenda.com/fr/articles/8302244-menu-droit-d-une-revision-informations-de-revision).
...
**Boîte de dialogue des informations de révision** Cliquez sur la zone de révision pour voir un aperçu de toutes les révisions du document dans la [boîte de dialogue des informations de révision](https://support.catenda.com/fr/articles/8302244-menu-droit-d-une-revision-informations-de-revision#h_6838c6ad71). Un lien vert entre une révision publiée et une révision partagée indique quelle révision partagée a été publiée.
...
1. L'accès à la configuration du statut du document peut être configuré à partir de la [page des paramètres du projet](https://support.catenda.com/fr/articles/4670273-page-des-parametres-du-projet) :
...
1. Le statut des documents peut ensuite être [configuré](https://support.catenda.com/fr/articles/7831371-page-des-parametres-du-document#h_e6f3ffdbff) à partir des paramètres dans la section documents :
...
1. Enfin, ces statuts de document peuvent être assignés au statut de révision de fichier accessible depuis le bouton à trois points en haut à droite dans la [section Approbations](https://support.catenda.com/fr/articles/8349340-page-des-validations-heritage). Il est également possible de configurer ici un modèle de sujet.
