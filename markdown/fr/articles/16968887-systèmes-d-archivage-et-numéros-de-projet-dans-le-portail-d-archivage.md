...
Pour extraire les données du projet de Catenda Hub d'autres façons, y compris les exportations, les formats à long terme et l'option d'archive gelée, voir [Exportation de toutes les données du projet](https://support.catenda.com/fr/articles/7946690-exporter-toutes-les-donnees-du-projet).
