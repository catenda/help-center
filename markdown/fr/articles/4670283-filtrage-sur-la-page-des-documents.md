...
Publié - `publishedAtFrom=<UTC timestamp>&publishedAtTo=<UTC timestamp>` Cliquez sur Sélectionner des dates pour sélectionner les dates entre lesquelles vous souhaitez effectuer une recherche Cliquez [ici](https://support.catenda.com/fr/articles/6511685-filtre-de-date) pour en savoir plus sur le filtre de date
...
Supprimé - `deleted=deleted&subFolders=true` Voir [ici](https://support.catenda.com/fr/articles/4670249-restauration-recuperation-de-documents-ou-de-dossiers) comment rechercher les documents supprimés
