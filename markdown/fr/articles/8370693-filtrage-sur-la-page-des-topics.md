...
Le menu de filtre dans une liste de sujets peut être ouvert en cliquant sur le bouton de filtre à gauche de la barre de recherche dans une [liste de sujets](https://support.catenda.com/fr/articles/4670271-page-sujets).
...
Cliquez sur le filtre pour ouvrir la liste filtrée sur l'ensemble enregistré des filtres qui ont reçu un nom. Cliquez [ici](https://support.catenda.com/fr/articles/8551755-limitation-des-resultats-de-filtrage) pour en savoir plus sur comment enregistrer un ensemble de filtres.
