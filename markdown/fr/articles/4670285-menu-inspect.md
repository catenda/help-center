...
Le menu Inspect se trouve comme premier menu dans le [panneau d'informations](https://support.catenda.com/fr/articles/8238584-panneau-d-information).

![](https://raw.githubusercontent.com/catenda/help-center/main/images/s5wpkh4e/01-intro.png)

Sélectionnez un objet dans la [Visionneuse 3D](https://support.catenda.com/fr/articles/8227211-visionneuse-3d) ou [panneau d'arborescence](https://intercom.help/bimsync-arena/fr/articles/4670290-panneau-arborescence-du-modele) pour commencer. Les propriétés et les informations connexes sont affichées dans le menu Inspect. Après avoir sélectionné un objet, le panneau Inspect peut ressembler à ceci :
...
Dans le menu Sujets, vous pourrez voir s'il y a des Sujets ouverts ou fermés qui sont [liés à](https://support.catenda.com/fr/articles/8053299-menu-de-droite-dans-un-sujet#h_758f17abbc) votre objet sélectionné ou vos objets sélectionnés. Le menu Sujets peut ressembler à ceci :
...
Si votre objet sélectionné ou vos objets sélectionnés sont [liés à des documents](https://support.catenda.com/fr/articles/8302244-menu-droit-d-une-revision-informations-de-revision#h_d0769e55eb) ou des éléments de bibliothèque, vous pourrez les voir ici. Le menu Bibliothèques peut ressembler à ceci :
