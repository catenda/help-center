...
- Domaines Catenda :
    - `catenda.com`
    - `*.catenda.com`
        - `webviewer.catenda.com`<br>Ce sous-domaine doit être autorisé dans le pare-feu pour afficher l'aperçu des documents sur la page d'aperçu des documents.
    - `*.*.catenda.com`
...
- Pour l'utilisation de plugins et d'intégrations qui utilisent les sujets listés [ici](https://support.catenda.com/fr/articles/8396532-catenda-plugins-and-integrations)
